var r=Object.defineProperty;var c=(t,e,s)=>e in t?r(t,e,{enumerable:!0,configurable:!0,writable:!0,value:s}):t[e]=s;var o=(t,e,s)=>(c(t,typeof e!="symbol"?e+"":e,s),s);import{F as l}from"./item.firebase-BPDxRCjr.js";const d="/shop_electrics/addCart.png";class g{constructor(){o(this,"_back",()=>{window.location.href="/shop_electrics/index.html"});o(this,"_bag",()=>{window.location.href="/shop_electrics/bag.html"});o(this,"renderInfo",e=>{if(!e)this.infoNode.innerHTML="Упс, ошибка. Такого товара нет.";else{const s="$";this.infoNode.innerHTML=`
